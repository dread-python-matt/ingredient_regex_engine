...
@pytest.mark.parametrize(
    "unit_name, expected",
    [
        ("gram", ["gram", "grama", "gramem", "gramy", "gramami"]),
        ("opakowanie", ["opakowanie", "opakowania", "opakowaniem", "opakowań", "opakowaniami"]),
        ("paczka", ["paczka", "paczki", "paczkę", "paczką", "paczek", "paczkami"]),
        ("szczypta", ["szczypta", "szczypty", "szczyptę", "szczyptą", "szczypt", "szczyptami"]),
        (
            "mililitr",
            ["mililitr", "mililitra", "mililitrem", "mililitry", "mililitrów", "mililitrami"],
        ),
    ],
)
